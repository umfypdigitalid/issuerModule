...
<body class="hold-transition skin-purple sidebar-mini">
    <div class="wrapper">
              ...
              ?>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="#"><i class="fa fa-circle-o"></i> Missing/Lost</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="table5_feedback.php?username=<?php echo $username=$_GET['username'];?>"><i class="fa fa-circle-o"></i> Feedback</a></li>
                        </ul>
                    </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Digital ID Missing/Lost
                    <small>control panel</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-user-times"></i> Report</a></li>
                    <li class="active">missing/lost</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Digital ID rejected</h3>
                            </div><!-- /.box-header -->
                            <div class="box-body">
  ...
  var table =$("#example4").DataTable({
        ...
        $('#example4 tbody').on('click','button',function(e){

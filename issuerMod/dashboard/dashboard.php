        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Approved</a></li>
              <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Pending</a></li>
              <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i> Rejected</a></li>
            </ul>
          </li>
          <li>
            </a>
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa fa-comments-o "></i> <span>Feedback/Cmplaint</span>
              <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
              <li><a href="pages/tables/simple.html"><i class="fa fa-circle-o"></i> Simple tables</a></li>
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="nav-tabs-custom">
              ...
              <ul class="nav nav-tabs pull-right">
                <li class="pull-left header"><i class="fa fa-inbox"></i> User registration</li>
              </ul>
